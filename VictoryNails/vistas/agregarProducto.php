               ...
               ?>
                    ...
                    <div class="card-body">
                        ...
                        <form action="../controllers/control/productosController.php" method="POST">
                            <div class="form-group">
                                ...
                                <label>Nombré</label>
                                <input type="text" class="form-control" name="nombre_p"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="vendidos_p"
                                    value="<?php echo $producto->vendidos; ?>">
                            </div>
                            <div class="form-group">
                                <label>Imagen</label>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="descripcion_p"
                                    value="<?php echo $producto->descripcion; ?>">
                            </div>
                            <div class="form-group">
                                <label for="inputState">Activo</label>
                                <select name="activo_p" class="form-control">
                                    <option <?php if ($producto->activo==1) { ?>selected<?php } ?> value="1">Activo
                                    </option>
                                    <option <?php if ($producto->activo==0) { ?>selected<?php } ?> value="0">Inactivo
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                <label>Marca</label>
                                <input type="text" class="form-control" name="marca_p"
                ...
                <form action="../controllers/control/productosController.php" method="POST" class="pb-5">
                    <div class="form-row">
                        ...
                        <div class="col-md-4 mb-3">
                            <label>Precio</label>
                            <input type="text" class="form-control" maxlength="20" pattern="[0-9]+" name="precio_p"
                                required>

                        </div>
                        <div class="col-md-4 mb-3">
                            <label>Marca</label>
                            <input type="text" class="form-control " maxlength="20" pattern="[a-zA-Z]+" name="marca_p"
                                required>
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-3 mb-3">
                            <label>Stock</label>
                            <input type="text" class="form-control" name="stock_p" pattern="[0-9]+" minlength="1"
